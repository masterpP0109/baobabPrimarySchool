...
const Banner = () => {
  return (
    <div className='h-[95vh] relative bottom-10' style={{backgroundImage: "url('./images/admissionimg.png')", backgroundSize: 'cover'}}>
        <Navbar/>
        <h1 className='text-white text-6xl pl-[100px] mt-[80px] ml-16 font-[Galang]'>Start Your Journey Here <br /> Admissions at Baobab <br /> Primary School </h1>
        ...
        <div className='bg-transparent border-4 border-[#184C77] w-[26rem] h-40 ml-[63rem] mt-11 rounded-3xl relative'>
