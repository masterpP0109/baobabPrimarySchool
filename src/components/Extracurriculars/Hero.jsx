...
const Hero = () => {
  return (
    <div
      className="relative w-full h-[970px]"
      style={{ backgroundImage: "url('images/excurrbg.png')" }}
    >
      {/* Dark Overlay */}
      <div className="absolute inset-0 bg-[#184C77] opacity-60 z-10 text-gray-300" />
              ...
              <div className="w-[1290px] h-[200px] flex items-center px-[100px] py-[3px] justify-between mt-[-200px] bg-white rounded-[30px]">
                ...
                <div className="flex flex-col gap-[10px]">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-[180px] h-[50px] p-5 pb-[40px] text-[18px] text-white rounded-[20px] bg-[#184C77] hover:bg-white hover:text-[#184C77] transition-all duration-300 tracking-wide-30"
                  >
                    Apply Now
                  </motion.button>
                </div>
